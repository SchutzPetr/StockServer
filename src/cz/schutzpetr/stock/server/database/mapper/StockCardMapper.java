 ...
 * @version 1.0
 */
public class StockCardMapper implements RowMapper<StockCard> {
     ...
     */
    @Override
    public StockCard mapRow(ResultSet resultSet, int i) throws SQLException {
        return new StockCard(resultSet.getInt("card_id"),
